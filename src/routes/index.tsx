...
function WhatsAppFloat() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 hidden h-16 w-16 items-center justify-center rounded-full bg-[#017907] text-white shadow-[0_10px_30px_-10px_rgba(1,121,7,0.6)] animate-pulse-ring transition hover:scale-110 hover:bg-[#015d05] md:flex"
    >
